...
class m161215_165313_kid_application_form extends Migration {
    ...
    public function up() {
        $this->createTable('preschooler_data', [
            ...
            'parent_name' => $this->string(100)->notNull(),
            'parent_surname' => $this->string(100)->notNull(),
            ...
            'accept_rules' => $this->integer()->notNull()
        ]);
    }
