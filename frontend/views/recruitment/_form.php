...
<div class="preschooler-form">
    ...
    <?= $form->field($model,'birthdate')->widget(DatePicker::classname(),([
        'language' => 'pl',
        'options' => ['placeholder' => 'Wybierz datę urodzenia dziecka...'],
        'pluginOptions' => [
            'format' => 'yyyy-mm-dd',
            'autoclose' => true,
        ]
    ...
    <div class="form-group">
        <?= Html::submitButton('Zapisz dziecko do przedszkola', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
    </div>
